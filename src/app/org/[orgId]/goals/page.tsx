...
import { Target, Clock, Users, Zap, CheckCircle2, ChevronRight } from "lucide-react";
import Link from "next/link";

export default async function GoalsPage(props: { params: Promise<{ orgId: string }> }) {
                ...
                {projects && projects.length > 0 ? projects.map((project: any, i: number) => {
                    ...
                    return (
                        <Link
                            ...
                            className="block group animate-in fade-in slide-in-from-bottom-4 duration-400"
